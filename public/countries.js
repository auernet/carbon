// ISO 3166-1 alpha-2 country list with default ISO 4217 currency.
// Used for the jurisdiction picker. Flag is derived at render time from the code.
window.COUNTRIES = [
  ...
  { code: "LA", name: "Lao PDR", currency: "LAK" },
  ...
  { code: "MF", name: "Saint Martin (French)", currency: "EUR" },
  ...
  { code: "SX", name: "Sint Maarten (Dutch)", currency: "ANG" },
